...
export class ReportesComponent implements OnInit {
  ...
  downloadPDF() {
    ...
    html2canvas(data).then(canvas => {
      ...
      /* pdf.save('Reporte_GHJEAFR042.pdf'); // Generated PDF */
      pdf.save('Reporte Seguimiento.pdf'); // Generated PDF
    });
  }
  // *****************************************************************************************************************************************
  ...
  //     format: [612, 792]
  //   });
  //   var elementHTMLl = document.getElementById('GHJEAFR042');

  //   let elementHTML = elementHTMLl.innerHTML.toString()
